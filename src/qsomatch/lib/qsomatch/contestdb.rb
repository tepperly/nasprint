...
class ContestDatabase
  ...
  def addLog(contID, callsign, callID, email, powclass, opclass, multID, entID, name, club, numops, isCCE, isMobile, isNew, isSchool, isYL, isYouth, isOneDay, isCountyLine, isSundayOnly)
    @db.query("insert into Log (contestID, callsign, callID, email, powclass, opclass, multiplierID, entityID, name, club, numops, isCCE, isMOBILE, isNEW, isSCHOOL, isYL, isYOUTH, isONEDAY, isCOUNTYLINE, isSUNDAYONLY) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",

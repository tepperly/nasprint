    ...
    if not @connection
      ...
      if @connection 
        if @readonly
          ...
          @connection.query("create table if not exists CQPAccess (id bigint primary key auto_increment, expiration datetime not null, accessToken varchar(2048) not null, index expireind (expiration));")
        end
      end
    else
